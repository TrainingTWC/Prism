...
export const STORE_COORDINATES: Record<string, StoreCoordinate> = {
  ...
  'S190': { lat: 12.924418, lng: 77.688288, name: 'EcoWorld 4AB' },
  ...
  'S173': { lat: 28.715749, lng: 77.135109, name: 'Rohini Sec 14' },
  'S174': { lat: 28.538301, lng: 77.142750, name: 'Vasant Kunj' },
  'S176': { lat: 28.401059, lng: 77.103126, name: 'Capital CyberScape' },
  ...
  'S074': { lat: 18.562795, lng: 73.916770, name: 'Phoenix Market City - Pune' },
  ...
  'S104': { lat: 18.600453, lng: 73.756469, name: 'Phoenix Mall of the Millennium' },
  ...
  'S256': { lat: 19.220054, lng: 72.837944, name: 'Borivali Chikuwadi' },
