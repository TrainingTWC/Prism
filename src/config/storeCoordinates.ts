...
export const STORE_COORDINATES: Record<string, StoreCoordinate> = {
  ...
  'S022': { lat: 12.92104, lng: 77.68426, name: 'Eco World Bay' },
  ...
  'S189': { lat: 12.97811, lng: 77.71299, name: 'NXT Whitefield' },
  ...
  'S247': { lat: 12.893729, lng: 77.595726, name: 'Store S247' },
  ...
  'S112': { lat: 28.571697, lng: 77.379168, name: 'Noida Spectrum Mall' },
  ...
  'S174': { lat: 28.538237, lng: 77.140118, name: 'Vasant Kunj' },
  ...
  'S240': { lat: 18.931513, lng: 72.826932, name: 'Store S240' },
