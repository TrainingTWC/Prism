...
export class GdmLiveAudioVisuals3D extends LitElement {
  ...
  protected firstUpdated() {
    // FIX: Property 'shadowRoot' does not exist on type 'GdmLiveAudioVisuals3D'. Use 'this.renderRoot' which is the standard Lit property for accessing the component's root.
