...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  private firstUpdated() {
    // FIX: Property 'shadowRoot' does not exist on type 'GdmLiveAudioVisuals'. Use 'this.renderRoot' which is the standard Lit property for accessing the component's root.
