  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl overflow-hidden border-2 border-slate-300 dark:border-slate-600 mb-8" data-am-id={amId}>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 border-b-4 border-blue-500">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg ring-4 ring-blue-100 dark:ring-blue-900 flex-shrink-0">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-xl sm:text-3xl font-bold text-slate-900 dark:text-white truncate">{amName}</h3>
                <div className="flex flex-wrap items-center gap-2 mt-1.5">
                  <span className="px-2 py-1 sm:px-2.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs sm:text-sm font-semibold rounded-lg whitespace-nowrap">
                    {amSubmissions.length} survey{amSubmissions.length !== 1 ? 's' : ''}
                  </span>
                  <span className="px-2 py-1 sm:px-2.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs sm:text-sm font-semibold rounded-lg whitespace-nowrap">
                    {monthlyScores.length} month{monthlyScores.length !== 1 ? 's' : ''}
                  </span>
                  {/* AI Indicator */}
                  {feedbackData.isAiGenerated && (
                    <div className="flex items-center gap-1.5 px-2 py-1 sm:px-2.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg shadow-md">
            ...
            <button
              ...
              data-download="true"
              className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-4 py-2.5 sm:px-6 sm:py-3.5 rounded-2xl transition-all duration-200 hover:scale-105 font-bold shadow-lg w-full sm:w-auto"
            >
              <Download className="w-4 h-4 sm:w-5 sm:h-5" />
              <span>Download</span>
            </button>
          </div>
        </div>        <div className="p-4 sm:p-6 bg-slate-50 dark:bg-slate-900/50">
          {/* Performance Scores - Mobile Responsive Clickable Card */}
          {monthlyScores.length > 0 && (
            <div 
              onClick={loadingMonthly ? undefined : showScoresModal}
              className={`mb-6 bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-6 border-2 border-slate-300 dark:border-slate-600 transition-all duration-200 ${
                loadingMonthly 
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center shadow-md flex-shrink-0">
                    <BarChart3 className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  </div>
                  <div className="min-w-0">
                    <h4 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Performance Score</h4>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 sm:gap-3">
                {monthlyScores.slice(0, 6).map((ms, idx) => (
                  <div key={idx} className="bg-slate-100 dark:bg-slate-700 rounded-xl p-2 sm:p-3 border border-slate-300 dark:border-slate-600">
                    ...
                    <div className="text-lg sm:text-2xl font-bold text-violet-600 dark:text-violet-400">
                      {ms.score}
                    </div>
                  </div>
                ))}
              ...
              {monthlyScores.length > 6 && (
                <div className="text-center mt-3 text-xs sm:text-sm text-violet-600 dark:text-violet-400 font-medium">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
            ...
            >
              <div className="p-4 sm:p-5">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-md flex-shrink-0">
                    <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  </div>
                  <div className="min-w-0">
                    <h4 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Positives</h4>
            ...
            >
              <div className="p-4 sm:p-5">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-md flex-shrink-0">
                    <TrendingDown className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  </div>
                  <div className="min-w-0">
                    <h4 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Improvements</h4>
                    <p className="text-xs text-slate-600 dark:text-slate-400">Tap to view details</p>
                  </div>
                </div>
