...
interface QARegionPerformanceInfographicProps {
...
const QARegionPerformanceInfographic: React.FC<QARegionPerformanceInfographicProps> = ({ submissions }) => {
    const performanceData = useMemo(() => {
        ...
        submissions.forEach(s => {
            ...
            scoresByRegion[region].totalPercent += parseFloat(s.scorePercentage) || 0;
    ...
    return (
        <InfographicCard title="QA Performance by Region">
...
export default QARegionPerformanceInfographic;