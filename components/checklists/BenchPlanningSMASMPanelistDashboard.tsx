...
interface BenchPlanningSMASMPanelistDashboardProps {
  panelistId: string;
  panelistName: string;
  onTakeInterview: (candidate: Candidate) => void;
}

const BenchPlanningSMASMPanelistDashboard: React.FC<BenchPlanningSMASMPanelistDashboardProps> = ({
  panelistId,
  panelistName,
  onTakeInterview
}) => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg shadow-lg p-6 text-white">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-2xl font-bold">Panelist Dashboard - SM to ASM</h2>
        </div>
      ...
      {candidates.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-4">
            <div className="text-2xl font-bold text-gray-900 dark:text-white">{candidates.length}</div>
...
export default BenchPlanningSMASMPanelistDashboard;
